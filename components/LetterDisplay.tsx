  ...
  return (
    <>
      ...
      <div className="w-full max-w-4xl mx-auto mt-8 space-y-4 mobile-spacing">
        <div className="bg-gradient-to-br from-red-50 via-amber-50 to-blue-50 rounded-xl shadow-2xl p-6 sm:p-8 border-4 border-blue-600 relative overflow-hidden">
          {/* Gold accent corner */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-yellow-400 to-yellow-600 opacity-20 rounded-bl-full"></div>

          {/* Presidential Header */}
          <div className="text-center mb-6 pb-6 border-b-2 border-blue-600 relative">
            <div className="text-5xl mb-3">🇺🇸</div>
            <h2 className="text-3xl sm:text-4xl font-bold text-blue-900 font-[family-name:var(--font-playfair)]">
              LETTER FROM PRESIDENT TRUMP
            </h2>
            <p className="text-sm text-gray-600 mt-2">To: @{username}</p>
          </div>

          {/* Letter Content */}
          <div className="bg-white rounded-lg p-4 sm:p-6 shadow-inner border border-gray-200">
          ...
          <div className="mt-6 flex flex-col sm:flex-row flex-wrap gap-3 justify-center">
            <button
              type="button"
              onClick={handleCopy}
              className="btn-animate w-full sm:w-auto px-6 py-3 bg-blue-600 text-white font-bold rounded-lg shadow-lg flex items-center justify-center gap-2 min-h-[48px]"
            ...
            <button
              ...
              className="btn-animate w-full sm:w-auto px-6 py-3 bg-green-600 text-white font-bold rounded-lg shadow-lg flex items-center justify-center gap-2 min-h-[48px]"
            ...
            <button
              ...
              className="btn-animate w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white font-bold rounded-lg shadow-lg flex items-center justify-center gap-2 min-h-[48px]"
